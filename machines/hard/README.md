...
| 10 | Tally | Windows | SharePoint Enumeration, KeePass, SQL Server xp_cmdshell, Rotten Potato | Enumerate SharePoint for KeePass DB, SQL Server creds, xp_cmdshell for shell, RottenPotato for SYSTEM | [0xdf](https://0xdf.gitlab.io/2022/04/11/htb-tally.html), [IppSec](https://www.youtube.com/watch?v=l-wzBhc9wFc) |
